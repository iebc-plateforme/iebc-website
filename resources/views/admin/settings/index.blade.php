                ...
                <div class="card-body">
                    <form action="{{ route('admin.settings.update') }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-6">
                                ...
                                @if(isset($settings['company_logo']) && $settings['company_logo'])
                                    <div class="mt-2">
                                        <img src="{{ image_url($settings['company_logo']) }}" alt="Logo" class="img-thumbnail" style="max-height: 100px;">
                                    </div>
                                @endif
                            </div>
                        </div>
                        ...
                        <div class="row mb-3">
                            <div class="col-md-6">
                                ...
                                @if(isset($settings['site_favicon']) && $settings['site_favicon'])
                                    <div class="mt-2">
                                        <img src="{{ image_url($settings['site_favicon']) }}" alt="Favicon" class="img-thumbnail" style="max-height: 50px;">
                                    </div>
                                @endif
                        ...
                        <div class="alert alert-info mt-4">
                            <i class="fas fa-palette"></i> <strong>Personnalisation du Thème:</strong>
                            Pour personnaliser les couleurs, polices et le style visuel de votre site,
                            <a href="{{ route('admin.themes.index') }}" class="alert-link">gérez les thèmes ici</a>.
                        </div>
