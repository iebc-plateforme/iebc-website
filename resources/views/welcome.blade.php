    ...
    <div class="container">
        <div class="row align-items-center min-vh-100 py-5">
            <div class="col-lg-7">
                ...
                <p class="lead text-white mb-4 animate-fade-in-delay-1">
                ...
                <div class="animate-fade-in-delay-2">
                    <a href="{{ route('services') }}" class="btn btn-light btn-lg me-3 mb-3">
                        <i class="fas fa-briefcase me-2"></i>Nos Services
                    </a>
                    <a href="{{ route('contact') }}" class="btn btn-outline-light btn-lg mb-3">
...
@endphp
@if($financeIslamique)
<section class="py-5 bg-gradient-islamic text-white">
    <div class="container">
...
<section class="py-5">
    <div class="container">
        <div class="text-center mb-5">
            <h2 class="display-5 fw-bold mb-3">Nos Autres Services</h2>
            <p class="lead text-muted">Découvrez notre gamme complète de services professionnels</p>
        </div>
        <div class="row g-4">
                    ...
                    <div class="card h-100 border-0 shadow-sm service-card">
                        @if($service->icon)
                            <div class="card-img-top text-center p-4 bg-light">
                                <img src="{{ asset('storage/' . $service->icon) }}" alt="{{ $service->title }}" class="img-fluid" style="max-height: 80px;">
                            </div>
                        @else
                            <div class="card-img-top text-center p-4 bg-light">
        ...
        <div class="row g-4 text-center">
            <div class="col-md-3">
                <div class="stat-item">
                    ...
                    <h3 class="display-4 fw-bold">{{ \App\Models\Service::where('is_active', true)->count() }}</h3>
            ...
            <div class="col-md-3">
                <div class="stat-item">
                    ...
                    <h3 class="display-4 fw-bold">{{ \App\Models\Team::where('is_active', true)->count() }}</h3>
            ...
            <div class="col-md-3">
                <div class="stat-item">
                    ...
                    <h3 class="display-4 fw-bold">{{ \App\Models\Partner::where('is_active', true)->count() }}</h3>
            ...
            <div class="col-md-3">
                <div class="stat-item">
                    ...
                    <h3 class="display-4 fw-bold">{{ \App\Models\Post::where('is_published', true)->count() }}</h3>
...
<section class="py-5 bg-light">
    <div class="container">
        <div class="text-center mb-5">
            <h2 class="display-5 fw-bold mb-3">Actualités & Blog</h2>
            <p class="lead text-muted">Restez informé de nos dernières actualités</p>
        </div>
        <div class="row g-4">
                ...
                <div class="col-md-4">
                    <div class="card h-100 border-0 shadow-sm blog-card">
                        ...
                        <div class="card-body">
                            ...
                            <p class="card-text text-muted small">{{ Str::limit($post->excerpt ?? $post->content, 100) }}</p>
...
<section class="py-5">
    <div class="container">
        <div class="text-center mb-5">
            ...
            <p class="lead text-muted">Rencontrez les experts qui font la différence</p>
        </div>
        <div class="row g-4">
        ...
        <div class="text-center mt-5">
            <a href="{{ route('team') }}" class="btn btn-primary btn-lg">
...
<section class="py-5 bg-gradient text-white">
    <div class="container text-center">
        ...
        <p class="lead mb-5">Contactez-nous dès aujourd'hui pour discuter de vos besoins</p>
